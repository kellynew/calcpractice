...
For English Users: The English Support will add in a future release.

## Installation

It's Easy! Just download the `CalcPractice_x.x.apk` in the Latest Release.

If you want to check the source, you can download the `CalcPractice.aia` file and open it in AppInventor or just unzip it.
...
非常简单！只需下载最新的发布版中`CalcPractice_x.x.apk`即可。

如果你有查看源代码的需求，可以使用最新版AppInventor（自行百度）打开`CalcPractice.aia`文件或直接解压缩它。
